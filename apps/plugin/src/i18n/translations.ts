...
export const T = {
  ...
  'display.font.compact':   { en: 'Compact', ko: '컴팩트' },
  'display.font.mono':      { en: 'Mono', ko: '모노', ja: '等幅', zh: '等宽', es: 'Mono', de: 'Mono', fr: 'Mono', hi: 'मोनो' },
  'display.font.serif':     { en: 'Classic Serif', ko: '클래식 세리프' },
  'display.font.didot':     { en: 'Didot', ko: '디도' },
  'display.font.georgia':   { en: 'Georgia', ko: '조지아' },
  'display.font.avenir':    { en: 'Avenir', ko: '아베니르' },
  'display.font.helvetica': { en: 'Helvetica', ko: '헬베티카' },
  'display.font.futura':    { en: 'Futura', ko: '푸투라' },
  'display.font.gill':      { en: 'Gill Sans', ko: '길 산스' },
  'display.font.palatino':  { en: 'Palatino', ko: '팔라티노' },
  'display.font.courier':   { en: 'Courier', ko: '쿠리어' },
  'display.font.menlo':     { en: 'Menlo', ko: '멘로' },
  'display.font.korean-sans': { en: 'Korean Sans', ko: '한글 고딕' },
  'display.font.korean-serif': { en: 'Korean Serif', ko: '한글 명조' },
