...
export const T = {
  ...
  'display.fontSize':        { en: 'Text size', ko: '글자 크기', ja: '文字サイズ', zh: '文字大小', es: 'Tamaño del texto', de: 'Textgröße', fr: 'Taille du texte', hi: 'टेक्स्ट का आकार' },
  'display.fontSize.small':  { en: 'Small', ko: '작게', ja: '小', zh: '小', es: 'Pequeño', de: 'Klein', fr: 'Petite', hi: 'छोटा' },
  ...
  'display.font.times-new-roman': { en: 'Times New Roman', ko: '타임스 뉴 로만', ja: 'Times New Roman', zh: 'Times New Roman', es: 'Times New Roman', de: 'Times New Roman', fr: 'Times New Roman', hi: 'Times New Roman' },
  'display.font.academio': { en: 'Academio', ko: '아카데미오', ja: 'Academio', zh: 'Academio', es: 'Academio', de: 'Academio', fr: 'Academio', hi: 'Academio' },
  'display.font.copperplate': { en: 'Copperplate', ko: '카퍼플레이트', ja: 'Copperplate', zh: 'Copperplate', es: 'Copperplate', de: 'Copperplate', fr: 'Copperplate', hi: 'Copperplate' },
  'display.font.georgia': { en: 'Georgia', ko: '조지아', ja: 'Georgia', zh: 'Georgia', es: 'Georgia', de: 'Georgia', fr: 'Georgia', hi: 'Georgia' },
  'display.font.courier': { en: 'Courier', ko: '쿠리어', ja: 'Courier', zh: 'Courier', es: 'Courier', de: 'Courier', fr: 'Courier', hi: 'Courier' },
