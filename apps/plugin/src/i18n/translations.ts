...
export const T = {
  ...
  'op.goal':        { en: 'most stars (★) after 12 rounds wins — coins break ties', ko: '12라운드 뒤 별(★)이 가장 많으면 승리 — 동점이면 코인 많은 쪽이 이겨', ja: '12ラウンド後に星(★)が一番多い人の勝ち — 同点ならコインで決着', zh: '12回合后星星(★)最多者获胜 — 平局比金币', es: 'gana quien tenga más estrellas (★) tras 12 rondas — las monedas desempatan', de: 'die meisten Sterne (★) nach 12 Runden gewinnen — Münzen entscheiden', fr: 'le plus d’étoiles (★) après 12 manches gagne — les pièces départagent', hi: '12 राउंड बाद सबसे ज़्यादा सितारे (★) वाला जीतता है — बराबरी पर सिक्के' },
