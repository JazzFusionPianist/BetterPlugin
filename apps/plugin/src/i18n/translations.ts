...
export const T = {
  ...
  'trackExport.daw': { en: 'Source DAW', ko: '가져올 DAW' },
  'trackExport.lunaRange': { en: 'LUNA: entire session only.', ko: 'LUNA는 현재 세션 전체 내보내기를 지원해요.' },
  'trackExport.lunaBounds': { en: 'Renders LUNA tracks offline from session zero to the session end. No tracks are added to the project. Timeline selection and bus export are not yet supported.', ko: 'LUNA 트랙을 세션 시작부터 끝까지 오프라인으로 내보냅니다. 프로젝트에 트랙을 추가하지 않습니다. 타임라인 선택 구간과 버스 내보내기는 아직 지원하지 않습니다.' },
  ...
  'trackExport.loading': { en: 'Reading {daw} tracks…', ko: '{daw} 트랙 불러오는 중…' },
