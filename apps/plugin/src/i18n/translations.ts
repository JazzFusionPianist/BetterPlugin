...
export const T = {
  ...
  'op.rules':       { en: 'roll · walk the winding paths — blue gives, red takes. the ★ costs ¢20; first to 4 stars wins', ko: '주사위를 굴려 갈림길을 걸어 — 파랑은 주고 빨강은 뺏어. ★은 ¢20, 별 4개를 먼저 모으면 승리', ja: 'サイコロを振って分かれ道を歩こう — 青はくれる、赤は奪う。★は¢20、先に4つ集めたら勝ち', zh: '掷骰子走分岔路 — 蓝格给钱红格扣钱。★要¢20，先集4颗获胜', es: 'tira el dado y recorre los caminos — el azul da, el rojo quita. La ★ cuesta ¢20; el primero con 4 estrellas gana', de: 'würfle und wandere die Wege — Blau gibt, Rot nimmt. Der ★ kostet ¢20; wer zuerst 4 Sterne hat, gewinnt', fr: 'lance le dé et suis les chemins — le bleu donne, le rouge prend. L’étoile coûte ¢20 ; le premier à 4 étoiles gagne', hi: 'पासा फेंको और रास्तों पर चलो — नीला देता है, लाल लेता है। ★ की कीमत ¢20; पहले 4 सितारे वाला जीतता है' },
  ...
  'op.goal':        { en: 'first to 4 stars (★) wins — buy them for ¢20 on the ★ tile', ko: '별(★) 4개를 먼저 모으면 승리 — ★칸에서 ¢20에 살 수 있어', ja: '星(★)を先に4つ集めたら勝ち — ★マスで¢20で買える', zh: '先集齐4颗星星(★)获胜 — 在★格花¢20购买', es: 'gana el primero en juntar 4 estrellas (★) — cómpralas por ¢20 en la casilla ★', de: 'wer zuerst 4 Sterne (★) hat, gewinnt — am ★-Feld für ¢20 kaufen', fr: 'le premier à 4 étoiles (★) gagne — achète-les ¢20 sur la case ★', hi: 'पहले 4 सितारे (★) जुटाने वाला जीतता है — ★ खाने पर ¢20 में खरीदो' },
  'op.starsToWin':  { en: '★4 wins', ko: '★4 = 승리', ja: '★4で勝ち', zh: '★4获胜', es: '★4 gana', de: '★4 gewinnt', fr: '★4 gagne', hi: '★4 जीत' },
