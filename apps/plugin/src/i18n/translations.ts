...
export const T = {
  ...
  'trackExport.search': { en: 'Search tracks…', ko: '트랙 검색…' },
  'trackExport.selectAll': { en: 'Select all', ko: '전체 선택' },
  'trackExport.clearAll': { en: 'Clear', ko: '선택 해제' },
  'trackExport.selectResults': { en: 'Select results', ko: '검색 결과 선택' },
  'trackExport.clearResults': { en: 'Clear results', ko: '검색 결과 해제' },
  'trackExport.noResults': { en: 'No matching tracks.', ko: '검색 결과가 없어요.' },
  'trackExport.unavailable': { en: 'Unavailable', ko: '선택 불가' },
  'trackExport.details': { en: 'Export details', ko: '내보내기 안내' },
  ...
  // ───── Six more games (2026-09-11): sudoku / minesweeper / solitaire / connect4 / gomoku / reversi ─────
  'game.sudoku':          { en: 'sudoku', ko: '스도쿠', ja: '数独', zh: '数独', es: 'sudoku', de: 'Sudoku', fr: 'sudoku', hi: 'सुडोकू' },
  'game.sudokuDesc':      { en: 'solo · easy to hard', ko: '혼자서 · 난이도 선택', ja: 'ソロ・難易度選択', zh: '单人 · 三种难度', es: 'solo · fácil a difícil', de: 'solo · leicht bis schwer', fr: 'solo · facile à difficile', hi: 'सोलो · आसान से कठिन' },
  'game.minesweeper':     { en: 'minesweeper', ko: '지뢰찾기', ja: 'マインスイーパー', zh: '扫雷', es: 'buscaminas', de: 'Minesweeper', fr: 'démineur', hi: 'माइनस्वीपर' },
  'game.minesweeperDesc': { en: 'solo · easy to hard', ko: '혼자서 · 난이도 선택', ja: 'ソロ・難易度選択', zh: '单人 · 三种难度', es: 'solo · fácil a difícil', de: 'solo · leicht bis schwer', fr: 'solo · facile à difficile', hi: 'सोलो · आसान से कठिन' },
  'game.solitaire':       { en: 'solitaire', ko: '솔리테어', ja: 'ソリティア', zh: '纸牌接龙', es: 'solitario', de: 'Solitär', fr: 'solitaire', hi: 'सॉलिटेयर' },
  'game.solitaireDesc':   { en: 'klondike · world ranking', ko: '클론다이크 · 월드 랭킹', ja: 'クロンダイク・世界ランキング', zh: '经典接龙 · 世界排名', es: 'klondike · ranking mundial', de: 'Klondike · Weltrangliste', fr: 'klondike · classement mondial', hi: 'क्लोंडाइक · विश्व रैंकिंग' },
  'game.connect4':        { en: 'connect four', ko: '커넥트4', ja: 'コネクトフォー', zh: '四子棋', es: 'conecta 4', de: 'Vier gewinnt', fr: 'puissance 4', hi: 'कनेक्ट फोर' },
  'game.connect4Desc':    { en: 'drop · four in a row', ko: '떨어뜨려 넷을 이어', ja: '落として四つ並べ', zh: '落子 · 四连胜', es: 'suelta · cuatro en raya', de: 'fallen lassen · vier in einer Reihe', fr: 'lâche · quatre alignés', hi: 'गिराओ · चार एक पंक्ति में' },
  'game.gomoku':          { en: 'gomoku', ko: '오목', ja: '五目並べ', zh: '五子棋', es: 'gomoku', de: 'Gomoku', fr: 'gomoku', hi: 'गोमोकू' },
  'game.gomokuDesc':      { en: 'five in a row', ko: '다섯 개를 이어라', ja: '五つ並べたら勝ち', zh: '五子连珠', es: 'cinco en raya', de: 'fünf in einer Reihe', fr: 'cinq alignés', hi: 'पाँच एक पंक्ति में' },
  'game.reversi':         { en: 'reversi', ko: '리버시', ja: 'リバーシ', zh: '黑白棋', es: 'reversi', de: 'Reversi', fr: 'reversi', hi: 'रिवर्सी' },
  'game.reversiDesc':     { en: 'flank & flip', ko: '뒤집어서 차지해', ja: '挟んでひっくり返せ', zh: '夹击翻转', es: 'rodea y voltea', de: 'einschließen & umdrehen', fr: 'encercle et retourne', hi: 'घेरो और पलटो' },
  'bg.hintConnect4':      { en: 'tap a column to drop · four in a row wins', ko: '열을 눌러 떨어뜨려 · 네 개 연속이면 승리', ja: '列をタップして落とす・四つ並べで勝ち', zh: '点击一列落子 · 四连即胜', es: 'toca una columna · cuatro en raya gana', de: 'Spalte antippen · vier in einer Reihe gewinnt', fr: 'touche une colonne · quatre alignés gagnent', hi: 'कॉलम टैप करें · चार लगातार जीत' },
  'bg.hintGomoku':        { en: 'five in a row wins · black opens', ko: '다섯 개 연속이면 승리 · 흑이 먼저', ja: '五つ並べで勝ち・黒が先手', zh: '五子连珠获胜 · 黑先', es: 'cinco en raya gana · negras abren', de: 'fünf in einer Reihe gewinnt · Schwarz beginnt', fr: 'cinq alignés gagnent · les noirs ouvrent', hi: 'पाँच लगातार जीत · काला पहले' },
  'bg.hintReversi':       { en: 'flank to flip · most discs wins', ko: '사이에 끼워 뒤집어 · 돌이 많은 쪽이 승리', ja: '挟んで裏返す・多い方が勝ち', zh: '夹击翻转 · 棋子多者胜', es: 'rodea para voltear · más fichas gana', de: 'einschließen zum Umdrehen · meiste Steine gewinnen', fr: 'encercle pour retourner · le plus de pions gagne', hi: 'घेरकर पलटो · ज़्यादा गोटियाँ जीत' },
  'diff.label':           { en: 'difficulty', ko: '난이도', ja: '難易度', zh: '难度', es: 'dificultad', de: 'Schwierigkeit', fr: 'difficulté', hi: 'कठिनाई' },
  'diff.easy':            { en: 'easy', ko: '쉬움', ja: 'やさしい', zh: '简单', es: 'fácil', de: 'leicht', fr: 'facile', hi: 'आसान' },
  'diff.medium':          { en: 'medium', ko: '보통', ja: 'ふつう', zh: '中等', es: 'medio', de: 'mittel', fr: 'moyen', hi: 'मध्यम' },
  'diff.hard':            { en: 'hard', ko: '어려움', ja: 'むずかしい', zh: '困难', es: 'difícil', de: 'schwer', fr: 'difficile', hi: 'कठिन' },
  'sd.solved':            { en: 'solved', ko: '완성', ja: '完成', zh: '完成', es: 'resuelto', de: 'gelöst', fr: 'résolu', hi: 'हल हो गया' },
  'sd.mistakes':          { en: 'mistakes', ko: '실수', ja: 'ミス', zh: '错误', es: 'errores', de: 'Fehler', fr: 'erreurs', hi: 'गलतियाँ' },
  'sd.pencil':            { en: 'pencil', ko: '메모', ja: 'メモ', zh: '笔记', es: 'lápiz', de: 'Notiz', fr: 'crayon', hi: 'नोट' },
  'sd.erase':             { en: 'erase', ko: '지우기', ja: '消す', zh: '擦除', es: 'borrar', de: 'löschen', fr: 'effacer', hi: 'मिटाएँ' },
  'sd.hint':              { en: 'tap a cell · type 1–9 · N for pencil marks', ko: '칸을 누르고 · 1–9 입력 · N으로 메모', ja: 'マスをタップ・1〜9を入力・Nでメモ', zh: '点击格子 · 输入 1–9 · N 切换笔记', es: 'toca una casilla · escribe 1–9 · N para notas', de: 'Feld antippen · 1–9 tippen · N für Notizen', fr: 'touche une case · tape 1–9 · N pour les notes', hi: 'सेल टैप करें · 1–9 टाइप करें · N नोट के लिए' },
  'sd.endConfirm':        { en: 'leave this board? it won’t be scored.', ko: '이 판을 그만둘까? 점수는 기록되지 않아.', ja: 'この盤をやめますか？スコアは記録されません。', zh: '放弃这一局？将不计分。', es: '¿dejar este tablero? no se puntuará.', de: 'dieses Rätsel verlassen? es wird nicht gewertet.', fr: 'quitter cette grille ? elle ne sera pas comptée.', hi: 'यह बोर्ड छोड़ें? स्कोर दर्ज नहीं होगा।' },
  'ms.cleared':           { en: 'cleared', ko: '클리어', ja: 'クリア', zh: '通关', es: 'despejado', de: 'geschafft', fr: 'terminé', hi: 'साफ़' },
  'ms.boom':              { en: 'boom', ko: '펑', ja: 'ドカン', zh: '砰', es: 'bum', de: 'bumm', fr: 'boum', hi: 'धमाका' },
  'ms.mines':             { en: 'mines', ko: '지뢰', ja: '地雷', zh: '地雷', es: 'minas', de: 'Minen', fr: 'mines', hi: 'सुरंगें' },
  'ms.flagMode':          { en: 'flag', ko: '깃발', ja: '旗', zh: '标旗', es: 'bandera', de: 'Flagge', fr: 'drapeau', hi: 'झंडा' },
  'ms.hint':              { en: 'click to reveal · right-click or ⚑ mode to flag · F toggles', ko: '클릭해서 열기 · 우클릭 또는 ⚑ 모드로 깃발 · F로 전환', ja: 'クリックで開く・右クリックか⚑モードで旗・Fで切替', zh: '点击翻开 · 右键或 ⚑ 模式标旗 · F 切换', es: 'clic para abrir · clic derecho o modo ⚑ para marcar · F alterna', de: 'Klick öffnet · Rechtsklick oder ⚑-Modus markiert · F wechselt', fr: 'clic pour ouvrir · clic droit ou mode ⚑ pour marquer · F bascule', hi: 'क्लिक से खोलें · राइट-क्लिक या ⚑ मोड से झंडा · F से बदलें' },
  'ms.endConfirm':        { en: 'leave this board? it won’t be scored.', ko: '이 판을 그만둘까? 점수는 기록되지 않아.', ja: 'この盤をやめますか？スコアは記録されません。', zh: '放弃这一局？将不计分。', es: '¿dejar este tablero? no se puntuará.', de: 'dieses Feld verlassen? es wird nicht gewertet.', fr: 'quitter cette grille ? elle ne sera pas comptée.', hi: 'यह बोर्ड छोड़ें? स्कोर दर्ज नहीं होगा।' },
  'sol.won':              { en: 'you won', ko: '성공', ja: 'クリア', zh: '你赢了', es: 'ganaste', de: 'gewonnen', fr: 'gagné', hi: 'आप जीते' },
  'sol.moves':            { en: 'moves', ko: '수', ja: '手', zh: '步', es: 'movimientos', de: 'Züge', fr: 'coups', hi: 'चालें' },
  'sol.draw1':            { en: 'draw 1', ko: '한 장씩', ja: '1枚めくり', zh: '翻一张', es: 'robar 1', de: '1 ziehen', fr: 'tirer 1', hi: '1 खींचें' },
  'sol.draw3':            { en: 'draw 3', ko: '세 장씩', ja: '3枚めくり', zh: '翻三张', es: 'robar 3', de: '3 ziehen', fr: 'tirer 3', hi: '3 खींचें' },
  'sol.draw':             { en: 'draw', ko: '뒤집기', ja: 'めくる', zh: '翻牌', es: 'robar', de: 'ziehen', fr: 'tirer', hi: 'खींचें' },
  'sol.hint':             { en: 'tap a card, then where it goes · double-tap sends it up', ko: '카드를 누르고 놓을 곳을 눌러 · 더블탭하면 위로 올라가', ja: 'カードをタップして置き場所をタップ・ダブルタップで上へ', zh: '点选牌再点目的地 · 双击直接上牌', es: 'toca una carta y luego su destino · doble toque la sube', de: 'Karte antippen, dann das Ziel · Doppeltipp legt sie ab', fr: 'touche une carte puis sa destination · double-touche pour monter', hi: 'कार्ड टैप करें, फिर जगह · डबल-टैप ऊपर भेजता है' },
