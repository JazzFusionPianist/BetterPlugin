...
export const LATEST: { version: string; url: string } = { version: '1.0.11', url: 'https://github.com/JazzFusionPianist/BetterPlugin/releases/download/patch-on-slur-1.0.11/Patch-on-Slur-1.0.11.pkg' }
