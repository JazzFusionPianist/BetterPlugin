...
export const LATEST: { version: string; url: string } = { version: '1.0.15', url: 'https://github.com/JazzFusionPianist/BetterPlugin/releases/download/patch-on-slur-1.0.15/Patch-on-Slur-1.0.15.pkg' }
