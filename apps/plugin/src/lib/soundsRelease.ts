...
export const LATEST: { version: string; url: string } = { version: '1.0.13', url: 'https://github.com/JazzFusionPianist/BetterPlugin/releases/download/patch-on-slur-1.0.13/Patch-on-Slur-1.0.13.pkg' }
