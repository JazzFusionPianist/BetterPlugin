 ...
 * door out. Ported from the Orb Chat plug-in's studio; needs the games'
 * LanguageProvider above it (the language words write orb_lang).
 */

import { useEffect, useState } from 'react'
import type { SupabaseClient, User } from '@supabase/supabase-js'
import { useT } from '@/lib/games/i18n'
import { LANG_META } from '@/lib/games/i18nTypes'
      ...
      <div className="wd-set-scroll">
        ...
        <div className="wd-set-sec">
          ...
          <div className="wd-set-row">
            ...
            <span className="wd-set-v tab">{BUILD_SHA}</span>
          </div>
          <div className="wd-set-row">
