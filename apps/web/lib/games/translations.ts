...
export const T = {
  ...
  'op.rules':       { en: 'roll · walk the winding paths — blue gives, red takes. the ★ costs ¢20; most stars after 20 rounds wins', ko: '주사위를 굴려 갈림길을 걸어 — 파랑은 주고 빨강은 뺏어. ★은 ¢20, 20라운드 뒤 별 많은 쪽이 승리', ja: 'サイコロを振って分かれ道を歩こう — 青はくれる、赤は奪う。★は¢20、20ラウンド後に星が多い方の勝ち', zh: '掷骰子走分岔路 — 蓝格给钱红格扣钱。★要¢20，20回合后星星多者获胜', es: 'tira el dado y recorre los caminos — el azul da, el rojo quita. La ★ cuesta ¢20; más estrellas tras 20 rondas gana', de: 'würfle und wandere die Wege — Blau gibt, Rot nimmt. Der ★ kostet ¢20; die meisten Sterne nach 20 Runden gewinnen', fr: 'lance le dé et suis les chemins — le bleu donne, le rouge prend. L’étoile coûte ¢20 ; le plus d’étoiles après 20 manches gagne', hi: 'पासा फेंको और रास्तों पर चलो — नीला देता है, लाल लेता है। ★ की कीमत ¢20; 20 राउंड बाद सबसे ज़्यादा सितारे जीतते हैं' },
  ...
  'op.howto':       { en: 'how to play', ko: '게임 방법', ja: 'あそびかた', zh: '玩法', es: 'cómo jugar', de: 'Spielanleitung', fr: 'comment jouer', hi: 'कैसे खेलें' },
  'op.gotIt':       { en: 'got it', ko: '알겠어', ja: 'わかった', zh: '明白了', es: 'entendido', de: 'verstanden', fr: 'compris', hi: 'समझ गया' },
  'op.goal':        { en: 'most stars (★) after 20 rounds wins — coins break ties', ko: '20라운드 뒤 별(★)이 가장 많으면 승리 — 동점이면 코인 많은 쪽이 이겨', ja: '20ラウンド後に星(★)が一番多い人の勝ち — 同点ならコインで決着', zh: '20回合后星星(★)最多者获胜 — 平局比金币', es: 'gana quien tenga más estrellas (★) tras 20 rondas — las monedas desempatan', de: 'die meisten Sterne (★) nach 20 Runden gewinnen — Münzen entscheiden', fr: 'le plus d’étoiles (★) après 20 manches gagne — les pièces départagent', hi: '20 राउंड बाद सबसे ज़्यादा सितारे (★) वाला जीतता है — बराबरी पर सिक्के' },
  'op.coinsRule':   { en: 'coins: blue +¢3 · red −¢3 · each lap +¢5 — save ¢20 and buy a star on the ★ tile', ko: '코인: 파란 칸 +¢3 · 빨간 칸 −¢3 · 한 바퀴 +¢5 — ¢20을 모으면 ★칸에서 별을 살 수 있어', ja: 'コイン: 青 +¢3・赤 −¢3・1周 +¢5 — ¢20貯めて★マスで星を買おう', zh: '金币：蓝格+¢3 · 红格−¢3 · 每圈+¢5 — 攒够¢20在★格买星星', es: 'monedas: azul +¢3 · rojo −¢3 · vuelta +¢5 — junta ¢20 y compra una estrella en la casilla ★', de: 'Münzen: Blau +¢3 · Rot −¢3 · Runde +¢5 — spare ¢20 und kaufe am ★-Feld einen Stern', fr: 'pièces : bleu +¢3 · rouge −¢3 · tour +¢5 — économise ¢20 et achète une étoile sur la case ★', hi: 'सिक्के: नीला +¢3 · लाल −¢3 · हर चक्कर +¢5 — ¢20 जोड़कर ★ खाने पर सितारा खरीदो' },
  'op.itemsRule':   { en: 'items (✦): tap one before rolling — each button says what it does', ko: '아이템(✦): 주사위 굴리기 전에 눌러 써 — 버튼에 효과가 적혀 있어', ja: 'アイテム(✦): サイコロを振る前に使う — ボタンに効果が書いてある', zh: '道具(✦)：掷骰子前点击使用 — 按钮上写着效果', es: 'objetos (✦): usa uno antes de tirar — cada botón dice su efecto', de: 'Gegenstände (✦): vor dem Würfeln antippen — jeder Knopf erklärt sich', fr: 'objets (✦) : utilise-en un avant de lancer — chaque bouton explique son effet', hi: 'आइटम (✦): पासा फेंकने से पहले इस्तेमाल करो — हर बटन पर असर लिखा है' },
  'op.tilesRule':   { en: '⚡ draws a surprise event · ⚔ duels a rival with one die for up to ¢5', ko: '⚡는 돌발 이벤트 · ⚔는 상대와 주사위 한 개 대결 (최대 ¢5 획득)', ja: '⚡はランダムイベント・⚔はライバルとサイコロ勝負 (最大¢5)', zh: '⚡随机事件 · ⚔与对手掷骰对决（最多¢5）', es: '⚡ evento sorpresa · ⚔ duelo de dados por hasta ¢5', de: '⚡ zieht ein Ereignis · ⚔ Würfelduell um bis zu ¢5', fr: '⚡ tire un événement · ⚔ duel de dés jusqu’à ¢5', hi: '⚡ अचानक इवेंट · ⚔ पासे से द्वंद्व (अधिकतम ¢5)' },
  'op.itDouble':    { en: 'two dice — move 2–12', ko: '주사위 2개 — 2~12칸', ja: 'サイコロ2個 — 2〜12マス', zh: '两个骰子 — 走2–12格', es: 'dos dados — mueve 2–12', de: 'zwei Würfel — 2–12 Felder', fr: 'deux dés — avance de 2–12', hi: 'दो पासे — 2–12 कदम' },
  'op.itPick':      { en: 'move exactly 6', ko: '정확히 6칸 이동', ja: 'ちょうど6マス進む', zh: '正好走6格', es: 'mueve exactamente 6', de: 'genau 6 Felder', fr: 'avance de 6 pile', hi: 'ठीक 6 कदम' },
  'op.itMirror':    { en: 'swap spots with a rival, then roll', ko: '상대와 자리를 바꾸고 굴려', ja: '相手と場所を入れ替えて振る', zh: '与对手换位后掷骰', es: 'cambia de lugar con un rival y tira', de: 'tausche den Platz, dann würfle', fr: 'échange ta place, puis lance', hi: 'जगह बदलो, फिर पासा फेंको' },
  'op.pathHint':    { en: 'pick a path — ★ n = tiles to the star', ko: '길을 골라 — ★ 숫자는 별까지 남은 칸 수야', ja: '道を選んで — ★の数字は星までのマス数', zh: '选路 — ★数字是到星星的格数', es: 'elige camino — ★ n = casillas hasta la estrella', de: 'wähl einen Weg — ★ n = Felder bis zum Stern', fr: 'choisis — ★ n = cases jusqu’à l’étoile', hi: 'रास्ता चुनो — ★ n = सितारे तक खाने' },
  'op.buyWhy':      { en: 'stars are how you win', ko: '별이 곧 승리야', ja: '星が勝利のカギ', zh: '星星就是胜利', es: 'las estrellas dan la victoria', de: 'Sterne bringen den Sieg', fr: 'les étoiles font la victoire', hi: 'सितारे ही जीत हैं' },
  'op.map':         { en: 'map', ko: '지도', ja: 'マップ', zh: '地图', es: 'mapa', de: 'Karte', fr: 'carte', hi: 'नक्शा' },
  'op.follow':      { en: 'follow', ko: '따라가기', ja: '追いかける', zh: '跟随', es: 'seguir', de: 'folgen', fr: 'suivre', hi: 'पीछा करो' },
