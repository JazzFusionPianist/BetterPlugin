...
export const T = {
  ...
  // ───── Friends list ─────────────────────────────────────────────────────
  'friends.onLive':         { en: 'live now', ko: '라이브 중', ja: 'ライブ中', zh: '直播中', es: 'en directo', de: 'live', fr: 'en direct', hi: 'लाइव' },
  ...
  'live.streamTitlePlaceholder': { en: 'name the session (optional)', ko: '세션 이름 (선택)', ja: 'セッション名（任意）', zh: '给本次直播起个名字（可选）', es: 'nombra la sesión (opcional)', de: 'Session benennen (optional)', fr: 'nommez la session (facultatif)', hi: 'सत्र का नाम (वैकल्पिक)' },
  ...
  'chat.fileExpired':   { en: 'expired — files last 7 days', ko: '만료됨 — 파일은 7일간 보관돼요', ja: '期限切れ — ファイルの保存は7日間', zh: '已过期 — 文件保留 7 天', es: 'expirado — los archivos duran 7 días', de: 'abgelaufen — Dateien halten 7 Tage', fr: 'expiré — les fichiers durent 7 jours', hi: 'समाप्त — फ़ाइलें 7 दिन रहती हैं' },
  ...
  'chat.sendFailed':    { en: 'couldn’t send — try again.', ko: '전송하지 못했어요 — 다시 시도해 주세요.', ja: '送信できませんでした — もう一度お試しください。', zh: '发送失败 — 请重试。', es: 'no se pudo enviar — inténtalo de nuevo.', de: 'Senden fehlgeschlagen — bitte erneut versuchen.', fr: 'échec de l’envoi — réessayez.', hi: 'भेज नहीं सके — पुनः प्रयास करें।' },
  ...
  'conv.emptyFavorites': { en: 'no favourite conversations', ko: '즐겨찾기한 대화가 없습니다', ja: 'お気に入りの会話がありません', zh: '没有收藏的对话', es: 'no hay conversaciones favoritas', de: 'keine Favoritengespräche', fr: 'aucune conversation favorite', hi: 'कोई पसंदीदा बातचीत नहीं' },
  ...
  'conv.youSentAudio':   { en: 'you sent audio', ko: '오디오를 보냈습니다', ja: '音声を送信しました', zh: '你发送了音频', es: 'enviaste un audio', de: 'du hast Audio gesendet', fr: 'vous avez envoyé un audio', hi: 'आपने ऑडियो भेजा' },
  'conv.sentAudio':      { en: 'sent audio', ko: '오디오를 보냈습니다', ja: '音声を送信しました', zh: '发送了音频', es: 'envió un audio', de: 'hat Audio gesendet', fr: 'a envoyé un audio', hi: 'ऑडियो भेजा' },
  ...
  'game.fallingBlocksDesc':  { en: '2–4 players', ko: '2-4인 대전', ja: '2〜4人で対戦', zh: '2-4 人对战', es: '2-4 jugadores', de: '2–4 Spieler', fr: '2-4 joueurs', hi: '2-4 खिलाड़ी' },
  ...
  // ───── Game lobby / common ──────────────────────────────────────────────
  'game.readyToPlay':        { en: 'ready?', ko: '준비됐나요?', ja: 'プレイ準備はOK？', zh: '准备好了吗？', es: '¿listo para jugar?', de: 'bereit zu spielen?', fr: 'prêt à jouer ?', hi: 'खेलने को तैयार?' },
  ...
  'game.playComputer':       { en: 'play the computer', ko: '컴퓨터와 대전', ja: 'コンピューターと対戦', zh: '与电脑对战', es: 'jugar contra la computadora', de: 'gegen Computer spielen', fr: 'jouer contre l’ordinateur', hi: 'कंप्यूटर से खेलें' },
  ...
  'alert.maxFileSize5mb':  { en: 'max file size is 5mb — choose a smaller one.', ko: '파일 크기는 최대 5MB — 더 작은 파일을 선택하세요.', ja: 'ファイルサイズは最大5MB — より小さいファイルを選んでください。', zh: '文件大小上限 5MB — 请选择更小的文件。', es: 'el tamaño máximo es 5 MB — elige un archivo más pequeño.', de: 'maximale Dateigröße 5 MB — bitte eine kleinere Datei wählen.', fr: 'taille maximale 5 Mo — choisissez un fichier plus petit.', hi: 'अधिकतम फ़ाइल आकार 5MB — छोटी फ़ाइल चुनें।' },
